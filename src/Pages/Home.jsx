  ...
  return (
    <div className="w-full h-full flex min-h-screen bg-body-color-light dark:bg-body-color-dark  overflow-y-hidden max-h-dvh ">
      ...
      <div className=" w-full min-h-full">
        ...
        <div className="h-[45px] py-3 px-5 w-full mt-2   border-b-[1px] border-border-lines-light dark:border-body-color-dark flex items-center justify-start max-sm:justify-between gap-5">
          <div className="h-fit w-fit flex justify-start items-center gap-5">
            <button className="h-[45px] flex items-center justify-center gap-1 text-dark-text dark:text-white/70 border-b-2 border-main-color select-none ">
              ...
              <p className="tracking-tight font-medium text-sm">Pipeline</p>
            </button>
            <button className="h-[45px] flex items-center justify-center gap-1 text-dark-text dark:text-light-text border-b-2 border-transparent select-none ">
              ...
              <p className="tracking-tight font-medium text-sm">List</p>
            </button>
          </div>

          <p className="text-dark-text/30 max-sm:hidden  ">|</p>
          <p className="tracking-tight text-sm text-dark-text/50 dark:text-light-text font-semibold  ">
            <span className="max-[350px]:hidden ">From</span>
            <span className=" px-2">
              <select
                name=""
              ...
              >
                <option className="dark:bg-stone-700" value="Nyabugogo">
                  Kigali
                </option>
                <option className="dark:bg-stone-700" value="Muhanga">
                  South
                </option>
                <option className="dark:bg-stone-700" value="Karongi">
                  East
                </option>
                <option className="dark:bg-stone-700" value="Huye">
                  West
                </option>
                <option className="dark:bg-stone-700" value="Huye">
                  North
          ...
          <p className="tracking-tight text-sm text-dark-text/50 font-semibold max-sm:hidden">
