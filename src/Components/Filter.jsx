        ...
        >
          ...
          <div className="h-full w-fit max-md:w-full relative">
            <input
              ...
              className="bg-white ring-0 ring-stone-200/50 dark:placeholder:text-dark-text h-full max-md:h-[40px] w-full capitalize max-w-[240px] max-md:max-w-[100%] rounded-full px-5 font-medium tracking-tight text-sm"
            />
            <div
