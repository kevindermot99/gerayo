...
function Sidebar() {
  ...
  return (
    <>
    <div className="absolute left-3 top-4 cursor-pointer " onClick={showsidebar}><HiMenuAlt2 className="text-2xl text-dark-text" /></div>
      <div className={`min-w-[250px] w-[250px] border-r-[1px] bg-body-color-light z-30 border-border-lines-light flex flex-col max-h-dvh max-lg:fixed transition-all duration-300  ${sidebar ? 'max-lg:left-[0px]' : 'max-lg:left-[-250px] '}`}>
