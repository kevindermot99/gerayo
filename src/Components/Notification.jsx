...
function Notification({ hide }) {
  ...
  return (
    <>
      ...
      <div className={`fixed top-0 right-0 bg-white text-dark-text w-full max-w-[500px] h-full z-40 p-4 transition-all ease-in-out duration-300 ${animate ? 'translate-x-0 opacity-100' : 'translate-x-full opacity-0 '}`}>
